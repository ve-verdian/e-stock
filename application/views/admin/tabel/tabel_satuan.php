...
<head>
  ...
  <title>Inventory EDP | Data Satuan</title>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="<?= base_url('admin/tabel_satuan')?>"><i class="fa fa-circle-o"></i> Data Satuan</a></li>
          </ul>
        </li>
        <li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li>Tables</li>
        <li class="active"><a href="<?=base_url('admin/tabel_satuan')?>">Data Satuan</a></li>
      </ol>
    </section>
