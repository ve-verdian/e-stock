              ...
              <div class="card card-danger">
                ...
                <form class="form-horizontal" action="<?=base_url('admin/proses_pc_update')?>" role="form"
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group row">
                      <label for="divisi" class="col-sm-2 col-form-label" style="text-align:right">Departemen / Divisi</label>
                      <div class="col-sm-10">
                    ...
                    <div class="form-group row">
                      <label for="hostname" class="col-sm-2 col-form-label" style="text-align:right">Hostname</label>
                      <div class="col-sm-10">
												<input type="text" name="hostname" class="form-control" id="hostname" placeholder="Hostname" value="<?=$dpc->hostname?>">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="user" class="col-sm-2 col-form-label" style="text-align:right">User</label>
                      <div class="col-sm-10">
												<input type="text" name="user" class="form-control" id="user" placeholder="User" value="<?=$dpc->user?>">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="jenis" class="col-sm-2 col-form-label" style="text-align:right">Jenis</label>
                      <div class="col-sm-10">
												<input type="text" name="jenis" class="form-control" id="jenis" placeholder="Jenis" value="<?=$dpc->jenis?>">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="hard_disk" class="col-sm-2 col-form-label" style="text-align:right">Harddisk</label>
                      <div class="col-sm-10">
												<input type="text" name="hard_disk" class="form-control" id="hard_disk" placeholder="Harddisk" value="<?=$dpc->hard_disk?>">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="ram" class="col-sm-2 col-form-label" style="text-align:right">RAM</label>
                      <div class="col-sm-10">
												<input type="text" name="ram" class="form-control" id="ram" placeholder="RAM" value="<?=$dpc->ram?>">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="processor" class="col-sm-2 col-form-label" style="text-align:right">Processor</label>
                      <div class="col-sm-10">
												<input type="text" name="processor" class="form-control" id="processor" placeholder="Processor" value="<?=$dpc->processor?>">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="os" class="col-sm-2 col-form-label" style="text-align:right">Operating System</label>
                      <div class="col-sm-10">
												<input type="text" name="os" class="form-control" id="os" placeholder="Operating System" value="<?=$dpc->os?>">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="ip_address" class="col-sm-2 col-form-label" style="text-align:right">IP Address</label>
                      <div class="col-sm-10">
                    ...
                    <div class="form-group row">
                      <label for="internet" class="col-sm-2 col-form-label" style="text-align:right">Internet</label>
                      <div class="col-sm-10">
                    ...
                    <div class="form-group row">
                      <label for="lokal" class="col-sm-2 col-form-label" style="text-align:right">Lokal</label>
                      <div class="col-sm-10">
                    ...
                    <div class="form-group row">
                      <label for="simrs" class="col-sm-2 col-form-label" style="text-align:right">SIM-RS</label>
                      <div class="col-sm-10">
