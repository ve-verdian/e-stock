        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary" style="width:94%;">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-archive" aria-hidden="true"></i> Update Data Divisi</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <div class="container">
            <form action="<?=base_url('admin/proses_divisi_update')?>" role="form" method="post">
                  ...
                  <?php foreach($data_divisi as $dv){ ?>
                    <div class="box-body">
                      <div class="form-group" style="display:inline-block;">
                        <input type="hidden" name="id_satuan" value="<?=$dv->id_divisi?>">
                        <label for="kode_divisi" style="width:87%;margin-left: 12px;">Kode Divisi</label>
                        <input type="text" required name="kode_divisi" style="width: 90%;margin-right: 67px;margin-left: 11px;" class="form-control" id="kode_divisi" placeholder="Kode Divisi" value="<?=$dv->kode_divisi?>">
                      </div>
                      <div class="form-group" style="display:inline-block;">
                        <label for="nama_divisi" style="width:73%;">Nama Divisi</label>
                        <input type="text" required name="nama_divisi" style="width:90%;margin-right: 67px;" class="form-control" id="nama_divisi" placeholder="Nama Divisi" value="<?=$dv->nama_divisi?>">
                    </div>
                    <div class="form-group" style="display:inline-block;">
